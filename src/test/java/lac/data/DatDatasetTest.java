...
public class DatDatasetTest extends TestSuite {
    private Dataset dataset;

    @Before
    public void setup() throws Exception {
        ClassLoader classLoader = getClass().getClassLoader();
        File file = new File(classLoader.getResource("data/dataset.dat").getFile());
        dataset = new DatDataset(file.getAbsolutePath());
    }
