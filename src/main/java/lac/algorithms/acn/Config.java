...
/**
 * Configuration for ACN algorithm.
 */
public class Config extends lac.algorithms.Config {
    ...
    /**
     * Set the value of minimum accuracy
     * 
     * @param minAcc minimum value of acc
     */
    ...
    /**
     * Set the value of minimum correlation
     * 
     * @param minCorr minimum value of correlation
     */
     ...
     * @param minCorr minimum value of correlation
     */
    public void setMinCorr(Integer minCorr) {
        this.minCorr = minCorr;
    }
    ...
    /**
     * Minimum value of accuracy for the rules
     * 
     * @return minimum value for accuracy
     */
    ...
    /**
     * Minimum value of pearson correlation for the rules
     * 
     * @return minimum value for correlation
     */
    ...
    public String toString() {
        return "minSup=" + this.minSup + " minConf=" + this.minConf + " minCorr=" + this.minCorr + " minAcc="
                + this.minAcc;
    }
}
