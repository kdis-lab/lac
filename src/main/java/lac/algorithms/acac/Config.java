...
/**
 * Configuration for the ACAC algorithm. This algorithm requires three different
 * parameters.
 */
public class Config extends lac.algorithms.Config {
     ...
     */
    private double minConf = 1.0;

    /**
     * Minimum all-confidence for the rules
     */
    private double minAllConf = 0.5;
    ...
    /**
     * Set the value of minimum all-confidence
     * 
     * @param minAllConf minimum all-confidence threshold
     */
    public void setMinAllConf(Double minAllConf) {
     ...
     * @param minAllConf minimum all-confidence threshold
     */
    public void setMinAllConf(Integer minAllConf) {
        this.minAllConf = minAllConf;
    }
    ...
    /**
     * Minimum value of all-confidence for the rules
     * 
     * @return minimum value for all-confidence
     */
    public double getMinAllConf() {
        return this.minAllConf;
    }
    ...
    public String toString() {
        return "minSup=" + this.minSup + " minConf=" + this.minConf + " minAllConf=" + this.minAllConf;
    }
}
